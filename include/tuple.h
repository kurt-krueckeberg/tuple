...
template<class... Ts> struct tuple; //fwd reference

template<> struct tuple<> { // Template specializtion for empty list of template arguments, the base case of the tuple recursive structure.
